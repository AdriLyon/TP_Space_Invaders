...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 14 12:05:54 2021
...
Boutton = Button(fenetre, text = " Nouvelle partie ", command = nouvelPartie) #1er bouton Fin Programme
Boutton.grid(row = 3, column = 7, padx = 10, pady = 10)
